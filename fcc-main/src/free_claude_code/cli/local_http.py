...
Enhanced:
- Added simple health_check(url) helper for monitoring orchestrator.
"""
...
def health_check(url: str, timeout: float = 1.5) -> bool:
    """Simple orchestrator-friendly health check."""
    try:
